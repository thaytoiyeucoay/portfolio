...
export const projects: Project[] = [
  ...
  },
  {
    ...
    desc: "Giải thích, phát hiện vấn đề và ước lượng độ phức tạp từ đoạn mã.",
    img: "/projects/code-explainer.svg",
    tags: ["Next.js", "LLM", "Syntax Highlight"],
    link: "/code-explainer",
    status: "demo",
    live: "/code-explainer",
    category: "AI",
  ...
  {
    title: "Image Captioning + Tags",
    desc: "Sinh mô tả ảnh và gợi ý hashtag từ ảnh tải lên hoặc URL.",
    img: "/projects/image-caption.svg",
    tags: ["Next.js", "AI", "photo"],
    link: "/image-caption",
    status: "demo",
    live: "/image-caption",
    category: "AI",
  },
  {
    ...
    desc: "Tra cứu web và đối chiếu nguồn để chấm độ tin cậy của tin/link.",
    img: "/projects/fake-news.svg",
    tags: ["RAG", "Tavily", "LLM"],
    link: "/fake-news",
    status: "demo",
    live: "/fake-news",
